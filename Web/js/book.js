createBookOrNot(); // firstTime

window.onresize = createBookOrNot;

function createBookOrNot() {
    console.log(document.body.clientWidth)
    if (document.body.clientWidth > 1200) {

        let containerBook = document.getElementById('containerBook');
        containerBook.style.display = "block";
        ...
        for (let index = 0; index < lengthContent; index++) { // on parcourt chaque caractère de ce qui est écrit dans content
            ...
            if (cmptString > 1540) { // here we cut the text, it is where start the problems ^^
